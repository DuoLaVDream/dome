...
public class CodeGenerator {
    ...
    private static String authorName="Damon";     //作者
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("328263905")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/demo?characterEncoding=utf8&serverTimezone=UTC")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.drf."+packageName)// 自定义包路径
